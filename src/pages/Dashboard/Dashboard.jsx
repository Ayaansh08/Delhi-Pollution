        ...
        <div className="header-content">
          <div className="header-top">
            ...
            <div className="header-nav-buttons">
              <button className="btn-nav" onClick={() => navigate('/wards')} title="View all wards">
                📊 All Wards
              </button>
            </div>
          </div>
                ...
                <div className="source-breakdown">
                  <div className="source-item">
                    ...
                    <div className="source-bar">
                      <div className="source-fill" style={{width: '60%', background: '#F59E0B'}}></div>
                    </div>
                    <span className="source-percent">60%</span>
                  </div>
                  <div className="source-item">
                    <div className="source-header">
                    ...
                    <div className="source-bar">
                      <div className="source-fill" style={{width: '25%', background: '#EF4444'}}></div>
                    </div>
                    <span className="source-percent">25%</span>
                  </div>
                  <div className="source-item">
                    <div className="source-header">
                    ...
                    <div className="source-bar">
                      <div className="source-fill" style={{width: '15%', background: '#3B82F6'}}></div>
                    </div>
